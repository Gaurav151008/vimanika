    ...
    <div id='bg-ani' class='hoverInOut' style="position:relative;top:-65px;background-image: url('<?php echo assets('imgs/bg2.jpg')?>');background-size: cover;">
        ...
        <div class="row  no-gutters font-eng container">
            ...
            <br><br>
                ...
                <p class='text-white '>"Unlocking Potential: Comprehensive Drone Services and Training Solutions for Aspiring Pilots and Industry Professionals"</p>
        ...
        <div class='container'>
            <div class='row'>
                <div class='col-md-8 offset-md-2'>
                    ...
                    <h5 class='text-center pt-2'>"Elevating perspectives, pioneering aerial filming and drone photography."</h5>
                    <p class='text-center'>"Venturing beyond the skies, we offer precision air spray solutions for farming and beyond. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem voluptas laborum dolore non optio est tempore ab iste aliquam. Our aerial spraying services revolutionize traditional methods, delivering efficiency and effectiveness in crop management and beyond. With meticulous attention to detail, we elevate agricultural practices, ensuring sustainable growth and prosperity."</p>
                </div>
