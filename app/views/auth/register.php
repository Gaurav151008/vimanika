<?php require_once APP_ROOT."/app/views/layout/header.php"; ?>
    ...
    <div class="container font-eng mb-5" style="background-color: white!important;">
    <br><br>
        <div class="row no-gutter mt-5 mb-5">
            <div class="col-md-4  p-2  offset-md-4 mb-5 p-2">
                ...
                <?php endif;?>
                <form method="post"  action="<?=url('user/register')?>" class="box p-4 p-md-5  rounded ">
                    <h4 class="mb-2  pb-2 text-center   rounded">Register 
                    <hr class="shine-br">
                    </h4>
                    ...
                    <!--name -->
                    <input type="text" name="username" class="input_style login-email mt-3 font-weight-bold  border-bottom "   placeholder="N a m e "  autocomplete="off"/>
                    <?php
                    ...
                    <!--Email -->
                    <input type="email" name="email" class="input_style login-email mt-4 font-weight-bold  border-bottom "   placeholder="E m a i l"  autocomplete="off"/>
                    <?php
                    ...
                    ?>
                    <a href=' href="<?=url('user/login')?>"' class='mt-4 text-dark float-right font-weight-bold'>Login</a>
